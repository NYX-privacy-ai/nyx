...
async fn send_email(
    ...
    google::send_email(to, subject, body, cc, reply_to_message_id, account).await
}
...
async fn create_email_draft(
    ...
    google::create_draft(to, subject, body, account).await
}
...
async fn search_email(
    ...
    google::search_email(query, max_results, account).await
}
...
async fn create_calendar_event(
    ...
    google::create_calendar_event(summary, from, to, description, attendees, account).await
}
