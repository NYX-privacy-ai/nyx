...
import { d as resolveConfigDir, o as escapeRegExp, p as resolveUserPath, t as CONFIG_DIR, u as normalizeE164 } from "./utils-4FS48tZP.js";
import { S as requireActivePluginRegistry, _ as getChatChannelMeta, b as normalizeChatChannelId, h as CHAT_CHANNEL_ORDER, l as createSubsystemLogger, m as CHANNEL_IDS, n as runExec, u as defaultRuntime, v as normalizeAnyChannelId, x as getActivePluginRegistry } from "./exec-kbIbbKiD.js";
import { C as resolveOpenClawPackageRootSync, _ as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, y as ensureAgentWorkspace } from "./agent-scope-DdQkOxl9.js";
import { t as parseBooleanValue } from "./boolean-M-esQJt6.js";
import { W as isTruthyEnvValue } from "./model-auth-Dz75Htwr.js";
import { t as formatCliCommand } from "./command-format-BUxhT1xL.js";
import { E as resolveWhatsAppAccount, d as loadPluginManifestRegistry, h as resolveMemorySlotDecision, i as writeConfigFile, m as resolveEnableState, p as normalizePluginsConfig, t as loadConfig } from "./config-Bm_vQzVn.js";
import { n as LEGACY_MANIFEST_KEYS, r as MANIFEST_KEY } from "./parse-duration-De_tAQSe.js";
import { C as DEFAULT_OPENCLAW_BROWSER_COLOR, S as DEFAULT_BROWSER_EVALUATE_ENABLED, T as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, a as resolveOpenClawUserDataDir, b as DEFAULT_AI_SNAPSHOT_MAX_CHARS, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as stopChromeExtensionRelayServer, h as ensureChromeExtensionRelayServer, i as launchOpenClawChrome, l as createTargetViaCdp, m as getHeadersWithAuth, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, w as DEFAULT_OPENCLAW_BROWSER_ENABLED, x as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, y as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-CcBriVIJ.js";
import { t as parseFrontmatterBlock } from "./frontmatter-xwTm0734.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-CpBd3vZq.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C5J2tohK.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C5J2tohK.js")).closePlaywrightBrowserConnection();
		} catch {}
