...
import { C as resolveOpenClawPackageRootSync, D as buildAgentMainSessionKey, M as normalizeAgentId, N as normalizeMainKey, P as resolveAgentIdFromSessionKey, T as DEFAULT_AGENT_ID, _ as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, j as normalizeAccountId$1, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, w as DEFAULT_ACCOUNT_ID, y as ensureAgentWorkspace } from "./agent-scope-C8p552g7.js";
import { C as CONFIG_DIR, F as resolveUserPath, M as normalizeE164, N as resolveConfigDir, O as escapeRegExp, _ as normalizeAnyChannelId, b as getActivePluginRegistry, g as getChatChannelMeta, h as CHAT_CHANNEL_ORDER, l as createSubsystemLogger, m as CHANNEL_IDS, n as runExec, u as defaultRuntime, x as requireActivePluginRegistry, y as normalizeChatChannelId } from "./exec-RKWsVjT_.js";
import { O as isTruthyEnvValue, k as parseBooleanValue } from "./model-selection-BG3SCK40.js";
import { t as formatCliCommand } from "./command-format-CFzL448l.js";
import { _ as resolveEnableState, f as loadPluginManifestRegistry, g as normalizePluginsConfig, h as MANIFEST_KEY, i as writeConfigFile, k as resolveWhatsAppAccount, m as LEGACY_MANIFEST_KEYS, t as loadConfig, v as resolveMemorySlotDecision } from "./config-2b1WGSeH.js";
import { C as DEFAULT_OPENCLAW_BROWSER_COLOR, S as DEFAULT_BROWSER_EVALUATE_ENABLED, T as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, a as resolveOpenClawUserDataDir, b as DEFAULT_AI_SNAPSHOT_MAX_CHARS, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as stopChromeExtensionRelayServer, h as ensureChromeExtensionRelayServer, i as launchOpenClawChrome, l as createTargetViaCdp, m as getHeadersWithAuth, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, w as DEFAULT_OPENCLAW_BROWSER_ENABLED, x as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, y as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-BxmeoNyo.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-jAcIZwmG.js";
import { r as resolveSessionTranscriptPath, t as resolveDefaultSessionStorePath } from "./paths-NoJLLyMJ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CQUIpzrm.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CQUIpzrm.js")).closePlaywrightBrowserConnection();
		} catch {}
...
function sanitizeUserFacingText(text) {
	...
	if (shouldRewriteContextOverflowText(trimmed)) return "Context overflow: prompt too large for the model. Try again with less input or a larger-context model.";
...
const ERROR_PATTERNS = {
	...
	billing: [
		/(?:status|http|error|code)[:\s]*402\b/i,
		"payment required",
