...
You have access to `gog`, a CLI tool for the full Google Workspace suite: Gmail, Calendar, Drive, Docs, Sheets, Slides, Contacts, Tasks, and Chat. Use the `shell` tool to run gog commands.
